(() => {
  // ../basement-build/node_modules/three/build/three.core.js
  var REVISION = "171";
    ...
    raycast(raycaster2, intersects) {
      ...
      if (index !== null) {
        ...
        for (let i = start, l = end - 1; i < l; i += step) {
          const a = index.getX(i);
          const b = index.getX(i + 1);
          const intersect2 = checkIntersection(this, raycaster2, _ray$1, localThresholdSq, a, b);
          if (intersect2) {
        ...
        for (let i = start, l = end - 1; i < l; i += step) {
          const intersect2 = checkIntersection(this, raycaster2, _ray$1, localThresholdSq, i, i + 1);
          if (intersect2) {
            intersects.push(intersect2);
          }
        }
        if (this.isLineLoop) {
          const intersect2 = checkIntersection(this, raycaster2, _ray$1, localThresholdSq, end - 1, start);
          if (intersect2) {
            intersects.push(intersect2);
          }
        }
  ...
  function checkIntersection(object, raycaster2, ray, thresholdSq, a, b) {
    ...
    raycast(raycaster2, intersects) {
      ...
      if (index !== null) {
        ...
        for (let i = start, il = end; i < il; i++) {
          ...
          testPoint(_position$2, a, localThresholdSq, matrixWorld, raycaster2, intersects, this);
        }
      } else {
        const start = Math.max(0, drawRange.start);
        const end = Math.min(positionAttribute.count, drawRange.start + drawRange.count);
        for (let i = start, l = end; i < l; i++) {
          ...
          testPoint(_position$2, i, localThresholdSq, matrixWorld, raycaster2, intersects, this);
        }
      }
    }
    updateMorphTargets() {
  ...
  // ../basement-build/node_modules/three/build/three.module.js
...
void main() {
  ...
  // ../basement-build/node_modules/three/examples/jsm/controls/OrbitControls.js
  ...
  var countries = [
    {
      ...
      news: [
        ...
        {
          source: "TechCrunch",
          title: "US Senate passes landmark AI Safety & Innovation Act",
          time: "4h ago"
        },
        {
          source: "Bloomberg",
          title: "NVIDIA surpasses $4T market cap driven by AI chip demand",
          time: "6h ago"
        },
        {
          source: "The Verge",
    ...
    },
    {
      ...
      news: [
        {
          source: "SCMP",
          title: "DeepSeek releases open-source reasoning model rivaling GPT-5",
          time: "1h ago"
        },
        {
          source: "Xinhua",
          title: "Beijing launches national AI compute infrastructure initiative",
          time: "5h ago"
        },
        {
          source: "Nikkei Asia",
          title: "Baidu's autonomous robotaxi fleet expands to 15 Chinese cities",
          time: "7h ago"
        },
        {
          source: "Reuters",
          title: "China sets new global standard for AI ethics governance",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "BBC",
          title: "UK AI Safety Institute releases global risk assessment framework",
          time: "3h ago"
        },
        {
          source: "FT",
          title: "London solidifies position as Europe's leading AI startup hub",
          time: "6h ago"
        },
        {
          source: "The Guardian",
          title: "NHS deploys AI diagnostic tools across 200 hospitals nationwide",
          time: "9h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "DW",
          title: "Germany allocates \u20AC5B for sovereign AI computing infrastructure",
          time: "2h ago"
        },
        {
          source: "Handelsblatt",
          title: "SAP integrates generative AI across entire enterprise platform",
          time: "8h ago"
        },
        {
          source: "Reuters",
          title: "Berlin emerges as Europe's top destination for AI researchers",
          time: "12h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Le Monde",
          title: "Mistral AI raises \u20AC2B, becomes Europe's most valuable AI startup",
          time: "3h ago"
        },
        {
          source: "Reuters",
          title: "France leads EU push for balanced AI regulation framework",
          time: "7h ago"
        },
        {
          source: "AFP",
          title: "Paris hosts Global AI Summit with 80 nations in attendance",
          time: "11h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "CBC",
          title: "Montreal's AI ecosystem attracts record $4B in venture funding",
          time: "4h ago"
        },
        {
          source: "Globe & Mail",
          title: "Canada launches national AI workforce reskilling program",
          time: "9h ago"
        },
        {
          source: "Reuters",
          title: "Toronto researchers achieve quantum-AI integration milestone",
          time: "14h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "NHK",
          title: "Japan unveils \xA52 trillion investment in domestic AI chip development",
          time: "2h ago"
        },
        {
          source: "Nikkei",
          title: "Toyota deploys AI-powered manufacturing across all global plants",
          time: "6h ago"
        },
        {
          source: "Kyodo",
          title: "Japanese humanoid robots enter elder care facilities nationwide",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Yonhap",
          title: "Samsung announces next-gen AI memory chips for on-device inference",
          time: "3h ago"
        },
        {
          source: "Korea Herald",
          title: "Seoul government integrates AI assistants in all public services",
          time: "8h ago"
        },
        {
          source: "Reuters",
          title: "Naver launches Korean-optimized multimodal foundation model",
          time: "12h ago"
        }
      ]
    },
      ...
      news: [
        {
          ...
          title: "India's AI market projected to reach $17B by year-end 2025",
          time: "1h ago"
        },
        {
          source: "Economic Times",
          title: "Infosys and TCS deploy AI agents serving 500M rural citizens",
          time: "5h ago"
        },
        {
          source: "NDTV",
          title: "IIT consortium develops multilingual AI for 22 official languages",
          time: "9h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "ABC",
          title: "Australia establishes AI regulatory authority with binding powers",
          time: "4h ago"
        },
        {
          source: "AFR",
          title: "CSIRO partners with tech giants on climate-AI research initiative",
          time: "10h ago"
        },
        {
          source: "Reuters",
          title: "Australian mining sector saves $3B annually through AI optimization",
          time: "16h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Haaretz",
          title: "Israeli AI defense tech companies attract record global investment",
          time: "2h ago"
        },
        {
          source: "Times of Israel",
          title: "Tel Aviv ranks #3 globally in AI startups per capita",
          time: "7h ago"
        },
        {
          source: "Reuters",
          title: "Mobileye's autonomous driving AI deployed across European fleet",
          time: "11h ago"
        }
      ]
    },
      ...
      news: [
        {
          ...
          title: "Singapore launches Asia's first AI governance testing sandbox",
          time: "3h ago"
        },
        {
          source: "CNA",
          title: "National AI Strategy 2.0 targets full public sector AI integration",
          time: "8h ago"
        },
        {
          source: "Reuters",
          title: "Singapore becomes ASEAN hub for responsible AI development",
          time: "13h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Gulf News",
          title: "UAE's Falcon 3 model achieves top benchmark scores globally",
          time: "2h ago"
        },
        {
          source: "Khaleej Times",
          title: "Abu Dhabi invests $30B in AI data center infrastructure",
          time: "6h ago"
        },
        {
          source: "Reuters",
          title: "Dubai launches world's first fully AI-managed free trade zone",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Arab News",
          title: "Saudi Arabia opens largest AI research center in the Middle East",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "NEOM integrates autonomous AI systems across smart city infrastructure",
          time: "9h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Folha",
          title: "Brazil passes comprehensive AI regulation bill in historic vote",
          time: "4h ago"
        },
        {
          source: "Reuters",
          title: "S\xE3o Paulo's fintech sector leverages AI for financial inclusion",
          time: "8h ago"
        },
        {
          source: "G1",
          title: "Brazilian agritech uses AI satellites to monitor Amazon deforestation",
          time: "14h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "SVT",
          title: "Sweden's AI-powered healthcare system reduces diagnostic wait times by 60%",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "Spotify deploys next-gen AI music recommendation engine",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "NOS",
          title: "ASML advances AI-driven lithography for next-gen chip manufacturing",
          time: "3h ago"
        },
        {
          source: "Reuters",
          title: "Amsterdam's AI startup ecosystem grows 40% year-over-year",
          time: "9h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "SWI",
          title: "ETH Zurich team develops energy-efficient neuromorphic AI processor",
          time: "6h ago"
        },
        {
          source: "Reuters",
          title: "Geneva hosts international AI arms control negotiations",
          time: "12h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "ERR",
          title: "Estonia deploys AI across entire e-governance digital infrastructure",
          time: "4h ago"
        },
        {
          source: "Reuters",
          title: "Tallinn becomes Baltic hub for AI-powered cybersecurity startups",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "YLE",
          title: "Finland leads EU in AI literacy with free national education program",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "Nokia leverages AI for next-generation 6G network optimization",
          time: "11h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "TASS",
          title: "Yandex releases large language model trained on Russian-language corpus",
          time: "3h ago"
        },
        {
          source: "Reuters",
          title: "Russia accelerates domestic AI chip development amid sanctions",
          time: "8h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "CNA",
          title: "TSMC begins mass production of 2nm AI accelerator chips",
          time: "1h ago"
        },
        {
          source: "Reuters",
          title: "Taiwan's semiconductor AI ecosystem drives global chip innovation",
          time: "6h ago"
        },
        {
          source: "Nikkei",
          title: "MediaTek unveils on-device AI chip for edge computing applications",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "ANSA",
          title: "Italy hosts G7 AI governance summit in Rome",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "Italian fashion industry adopts AI for sustainable supply chain management",
          time: "11h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "El Pa\xEDs",
          title: "Barcelona becomes Southern Europe's fastest-growing AI hub",
          time: "4h ago"
        },
        {
          source: "Reuters",
          title: "Spain launches \u20AC1.5B national AI transformation plan",
          time: "9h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "PAP",
          title: "Warsaw attracts major AI research labs from global tech companies",
          time: "6h ago"
        },
        {
          source: "Reuters",
          title: "Polish universities launch joint AI research consortium",
          time: "12h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "NRK",
          title: "Norway uses AI to optimize offshore energy production",
          time: "4h ago"
        },
        {
          source: "Reuters",
          title: "Norwegian sovereign wealth fund integrates AI risk assessment tools",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "DR",
          title: "Denmark pioneers AI-powered green energy grid management",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "Copenhagen attracts record AI venture capital investment",
          time: "11h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "El Universal",
          title: "Mexico City launches AI-powered public transportation optimization",
          time: "6h ago"
        },
        {
          source: "Reuters",
          title: "Mexican tech sector sees 300% growth in AI-related jobs",
          time: "13h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Clar\xEDn",
          title: "Buenos Aires emerges as Latin America's AI talent development center",
          time: "7h ago"
        },
        {
          source: "Reuters",
          title: "Argentine startups leverage AI for agricultural technology solutions",
          time: "14h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Punch",
          title: "Lagos becomes Africa's fastest-growing AI startup ecosystem",
          time: "3h ago"
        },
        {
          source: "Reuters",
          title: "Nigerian fintech companies deploy AI to bank 50M unbanked citizens",
          time: "9h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Nation",
          title: "Nairobi's Silicon Savannah attracts global AI research partnerships",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "M-Pesa integrates AI fraud detection serving 50M mobile wallets",
          time: "11h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "News24",
          title: "South Africa launches continental AI strategy at African Union summit",
          time: "4h ago"
        },
        {
          source: "Reuters",
          title: "Cape Town tech hub develops AI solutions for water resource management",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Ahram",
          title: "Egypt opens Africa's largest AI-focused data center in Cairo",
          time: "6h ago"
        },
        {
          source: "Reuters",
          title: "Egyptian government deploys AI for Nile water management optimization",
          time: "12h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Anadolu",
          title: "Turkey launches national AI strategy targeting top-20 global ranking",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "Istanbul's defense tech sector integrates advanced AI systems",
          time: "11h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Kompas",
          title: "Indonesia partners with global tech firms for AI talent development",
          time: "4h ago"
        },
        {
          source: "Reuters",
          title: "Jakarta deploys AI traffic management reducing commute times by 25%",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "VnExpress",
          title: "FPT launches Vietnam's first homegrown large language model",
          time: "3h ago"
        },
        {
          source: "Reuters",
          title: "Vietnam's tech workforce grows 45% driven by AI outsourcing demand",
          time: "9h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Bangkok Post",
          title: "Thailand's Eastern Economic Corridor attracts AI manufacturing",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "Thai healthcare system pilots AI-assisted diagnostics in rural areas",
          time: "11h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Star",
          title: "Malaysia announces $2B AI data center investment from global tech giants",
          time: "2h ago"
        },
        {
          source: "Reuters",
          title: "Kuala Lumpur positions as ASEAN's AI-driven Islamic finance hub",
          time: "8h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Inquirer",
          title: "Philippines leverages AI to transform BPO industry for next decade",
          time: "6h ago"
        },
        {
          source: "Reuters",
          title: "Manila's startup scene embraces AI for disaster preparedness systems",
          time: "13h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "RNZ",
          title: "New Zealand develops ethical AI framework prioritizing indigenous rights",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "Auckland's agritech sector uses AI to optimize sustainable farming",
          time: "12h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "RTE",
          title: "Dublin hosts headquarters for multiple global AI safety research teams",
          time: "4h ago"
        },
        {
          source: "Reuters",
          title: "Ireland's data center boom drives European AI compute capacity",
          time: "10h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "Lusa",
          title: "Lisbon's Web Summit announces dedicated AI conference track expansion",
          time: "6h ago"
        },
        {
          source: "Reuters",
          title: "Portugal attracts AI remote workers with digital nomad visa program",
          time: "12h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "La Tercera",
          title: "Chile leads Latin America in AI-powered astronomical research",
          time: "5h ago"
        },
        {
          source: "Reuters",
          title: "Santiago launches AI-driven smart city initiative across metro area",
          time: "11h ago"
        }
      ]
    },
    {
      ...
      news: [
        {
          source: "El Tiempo",
          title: "Medell\xEDn transforms into Latin America's emerging AI innovation hub",
          time: "6h ago"
        },
        {
          source: "Reuters",
          title: "Colombia deploys AI systems for biodiversity conservation monitoring",
          time: "13h ago"
        }
      ]
    }
  ...
  var ambientLight = new AmbientLight(2241365, 0.4);
  ambientLight.name = "ambientLight1";
  scene.add(ambientLight);
  var sunLight = new DirectionalLight(16772829, 1.8);
  ...
  scene.add(sunLight);
  var rimLight = new DirectionalLight(4491519, 0.5);
  rimLight.name = "rimLight1";
  rimLight.position.set(-5, 2, -3);
  scene.add(rimLight);
  var starsGeo = new BufferGeometry();
  var starVerts = [];
  var starColors = [];
  for (let i = 0; i < 18e3; i++) {
    ...
    const c = new Color();
    c.setHSL(0.55 + Math.random() * 0.15, 0.3, 0.7 + Math.random() * 0.3);
    starColors.push(c.r, c.g, c.b);
  }
  starsGeo.setAttribute(
    "position",
    new Float32BufferAttribute(starVerts, 3)
  );
  starsGeo.setAttribute(
    "color",
    new Float32BufferAttribute(starColors, 3)
  );
  var starsMat = new PointsMaterial({
    size: 0.4,
    transparent: true,
    opacity: 0.8,
    vertexColors: true,
  ...
  var stars = new Points(starsGeo, starsMat);
  stars.name = "starfield1";
  scene.add(stars);
  var textureLoader = new TextureLoader();
  var dayTex = textureLoader.load(
    "https://raw.githubusercontent.com/mrdoob/three.js/master/examples/textures/planets/earth_atmos_2048.jpg"
  );
  var normalTex = textureLoader.load(
    "https://raw.githubusercontent.com/mrdoob/three.js/master/examples/textures/planets/earth_normal_2048.jpg"
  );
  var specTex = textureLoader.load(
    "https://raw.githubusercontent.com/mrdoob/three.js/master/examples/textures/planets/earth_specular_2048.jpg"
  );
  var earthGeo = new SphereGeometry(1, 128, 128);
  var earthMat = new MeshPhongMaterial({
    map: dayTex,
    normalMap: normalTex,
    normalScale: new Vector2(0.6, 0.6),
    specularMap: specTex,
    specular: new Color(2236996),
    shininess: 40
  });
  var earth = new Mesh(earthGeo, earthMat);
  earth.name = "earth1";
  earth.castShadow = true;
  earth.receiveShadow = true;
  scene.add(earth);
  var cloudsTex = textureLoader.load(
    "https://raw.githubusercontent.com/mrdoob/three.js/master/examples/textures/planets/earth_clouds_1024.png"
  );
  var cloudsGeo = new SphereGeometry(1.006, 64, 64);
  var cloudsMat = new MeshPhongMaterial({
    map: cloudsTex,
    transparent: true,
    opacity: 0.28,
    depthWrite: false
  });
  var clouds = new Mesh(cloudsGeo, cloudsMat);
  clouds.name = "clouds1";
  scene.add(clouds);
  var atmosGeo = new SphereGeometry(1.025, 64, 64);
  var atmosMat = new ShaderMaterial({
    ...
    fragmentShader: `
                ...
                varying vec3 vPos;
                void main(){
                    float rim = 1.0 - max(0.0, dot(vNormal, normalize(-vPos)));
                    float intensity = pow(rim, 3.0) * 0.65;
                    vec3 col = mix(vec3(0.15,0.35,0.85), vec3(0.4,0.7,1.0), rim);
  ...
  var atmos = new Mesh(atmosGeo, atmosMat);
  atmos.name = "atmosphere1";
  scene.add(atmos);
  ...
  function createTextSprite(text) {
    ...
    const scale = 0.08;
    sprite.scale.set(scale * aspect2, scale, 1);
    return sprite;
  }
  var labelGroup = new Group();
  labelGroup.name = "labelGroup1";
  scene.add(labelGroup);
  countries.forEach((c, idx) => {
    const pos = latLonToVec3(c.lat, c.lon);
    const dotGeo = new CircleGeometry(6e-3, 12);
    ...
    dot.lookAt(0, 0, 0);
    dot.name = `marker-dot-${idx}`;
    const labelPos = latLonToVec3(c.lat, c.lon, 1.06);
    const label = createTextSprite(c.name);
    label.position.copy(labelPos);
    label.name = `label-${idx}`;
    label.userData = { countryIdx: idx, basePos: labelPos.clone() };
    labelGroup.add(label);
    markerGroup.add(dot);
    markers.push({ dot, data: c, idx, pos, label });
  });
  var countTarget = countries.length;
  var countCurrent = 0;
  var counterEl = document.getElementById("countryCount");
  function animateCounter() {
    if (countCurrent < countTarget) {
      countCurrent++;
      counterEl.textContent = countCurrent;
      setTimeout(animateCounter, 40);
    }
  }
  setTimeout(animateCounter, 500);
  setTimeout(() => {
    document.getElementById("statsFill").style.width = "100%";
  }, 300);
  ...
  countries.forEach((c) => {
    c.news.forEach((n) => {
      tickerItems.push(
        `<span class="ticker-item"><span class="country-tag">${c.code}</span>${n.title}</span>`
      );
    });
  });
  ...
  document.getElementById("closePanel").addEventListener("click", () => infoPanel.classList.remove("active"));
  function showCountryPanel(c) {
    let newsHTML = c.news.map(
      (n) => `
                <div class="news-item">
    ...
    panelContent.innerHTML = `
                ...
                <div class="ai-index">
                    <div class="stat">
                        <div class="stat-val">${c.aiIndex}</div>
                        <div class="stat-label">AI Index</div>
                    </div>
                    <div class="stat">
                        <div class="stat-val">${c.news.length}</div>
                        <div class="stat-label">Stories Today</div>
                    </div>
                    <div class="stat">
                        <div class="stat-val">${c.news[0].time}</div>
  ...
  function onMouseMove2(e) {
    ...
    if (intersects.length > 0) {
      ...
      const m = markers.find((m2) => m2.dot === hit);
      if (m) {
        hoveredMarker = m;
        ...
        ttName.textContent = m.data.name;
        ttCount.textContent = `${m.data.news.length} AI stories \xB7 Index: ${m.data.aiIndex}`;
        m.dot.material.color.setHex(16777215);
      }
    } else {
      if (hoveredMarker) {
        hoveredMarker.dot.material.color.setHex(6599935);
        hoveredMarker = null;
      }
  ...
  document.getElementById("navLeft").addEventListener("click", () => {
    navIdx = (navIdx - 1 + countries.length) % countries.length;
    showCountryPanel(countries[navIdx]);
  });
  document.getElementById("navRight").addEventListener("click", () => {
    navIdx = (navIdx + 1) % countries.length;
    showCountryPanel(countries[navIdx]);
  });
  async function fetchLiveNews() {
    const feeds = [
      {
        url: "https://api.rss2json.com/v1/api.json?rss_url=https://news.google.com/rss/search?q=artificial+intelligence&hl=en-US&gl=US&ceid=US:en",
        region: "Global"
      }
    ];
    try {
      for (const feed of feeds) {
        ...
        if (resp.ok) {
          ...
          if (data.items && data.items.length > 0) {
            const liveItems = data.items.slice(0, 10).map((item) => {
              const title = item.title.replace(/<[^>]*>/g, "").substring(0, 100);
              return `<span class="ticker-item"><span class="country-tag">LIVE</span>${title}</span>`;
            });
            tickerTrack.innerHTML = liveItems.join("") + tickerTrack.innerHTML;
          }
        }
      }
    } catch (e) {
      console.log("RSS fetch unavailable, using curated data");
    }
  }
  fetchLiveNews();
  setInterval(fetchLiveNews, 3e5);
  var arcPairs = [
    [0, 1],
    [0, 3],
    [0, 6],
  ...
  arcPairs.forEach(([a, b], i) => {
    const pA = latLonToVec3(countries[a].lat, countries[a].lon, 1.01);
    const pB = latLonToVec3(countries[b].lat, countries[b].lon, 1.01);
  ...
  var time = 0;
  var _labelWorldPos = new Vector3();
  var _camDir = new Vector3();
  function animate() {
    time += 0.01;
    earth.rotation.y += 1e-3;
    clouds.rotation.y += 14e-4;
    markerGroup.rotation.y = earth.rotation.y;
    labelGroup.rotation.y = earth.rotation.y;
    markers.forEach((m, i) => {
      if (m.label) {
        m.label.getWorldPosition(_labelWorldPos);
        _camDir.copy(camera.position).normalize();
        const dot = _labelWorldPos.normalize().dot(_camDir);
        const targetOpacity = dot > 0.15 ? 0.9 : 0;
        m.label.material.opacity += (targetOpacity - m.label.material.opacity) * 0.1;
        m.label.material.visible = m.label.material.opacity > 0.01;
      }
    });
    starsMat.opacity = 0.7 + Math.sin(time * 1.5) * 0.1;
    controls.update();
